...
- replace a selected stream with a fixed 5 ms fade-out to silence followed by a 5 ms fade-in from the new stream's first frame, without changing the exposed Fade processing control;
