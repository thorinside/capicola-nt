...
The pinned upstream/platform revisions and traceable first-release processing surface are recorded in the [capability audit](docs/CAPABILITY_AUDIT.md). The initial buildable plugin slice implements the documented [normalized live-stereo routing](docs/LIVE_ROUTING.md); remaining approved capabilities are delivered incrementally.
